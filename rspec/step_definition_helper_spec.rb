...
describe StepDefinitionHelper do
  ...
  it "should read every line of a single step definition and segment those lines into steps identified by its location." do
    ...
    steps_array = @step_definition_helper.parse_step_definitions(file_name)
  ...
  it "should create a list of step definition objects from a step definition file." do
    ...
    step_definitions = @step_definition_helper.build_step_definitions(file_name)
  ...
  it "should create a list of step definition objects from a step definitions folder and its sub folders" do
    ...
    step_definitions = @step_definition_helper.build_step_definitions_from_folder(folder_name)
    ...
    expected_step_definitions = [
        ...
        StepDefinition.new("../features/step_definitions/dead_step_sorter_steps/simple_calculator_steps.rb:0", ["Given /^the first number is 1$/ do","@first_number = 1", "end"]),
